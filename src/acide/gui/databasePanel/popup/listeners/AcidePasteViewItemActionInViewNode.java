 ...
 * @see ActionListener
 */
public class AcidePasteViewItemActionInViewNode implements ActionListener {
	...
	public void actionPerformed(ActionEvent arg0) {
		try {
			...
			String database = AcideMainWindow.getInstance().getDataBasePanel().getTree().getSelectionPath().getParentPath().getParentPath().getLastPathComponent().toString();
