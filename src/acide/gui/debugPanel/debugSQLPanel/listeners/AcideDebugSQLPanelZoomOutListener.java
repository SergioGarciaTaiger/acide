...
/**
 *
 * ACIDE - A Configurable IDE trace SQL panel zoom out listener.
 *
 * @version 0.15 
 *
 */
public class AcideDebugSQLPanelZoomOutListener implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		if (AcideDebugSQLPanel._canvas != null)
			AcideDebugSQLPanel._canvas.zoomOut(CanvasPanel.DebugSQL);
